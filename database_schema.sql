...
('Mathematics', 'MATH', 'primary', 'Basic Mathematics'),
('English Language', 'ENG', 'primary', 'English Language and Literature'),
('Science', 'SCI', 'primary', 'Basic Science'),
('Social Studies', 'SOC', 'primary', 'Social Studies'),
('Mathematics', 'MATH', 'junior', 'Junior Secondary Mathematics'),
('English Language', 'ENG', 'junior', 'Junior Secondary English'),
('Basic Science', 'BSC', 'junior', 'Basic Science'),
('Social Studies', 'SOC', 'junior', 'Social Studies'),
('Mathematics', 'MATH', 'senior', 'Senior Secondary Mathematics'),
('English Language', 'ENG', 'senior', 'Senior Secondary English'),
('Physics', 'PHY', 'senior', 'Physics'),
('Chemistry', 'CHEM', 'senior', 'Chemistry'),
